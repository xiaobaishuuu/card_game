...
#reminder
COMBO_REMINDER_RATIO    = 1.3
COMBO_REMINDER_BG_COLOR = (7, 61, 31)
BETTING_REMINDER_RATIO    = 1.5
BETTING_REMINDER_BG_COLOR = (15, 15, 15)
...
HAND_POSITION = [[(PLAYER_INFO_BAR_POSITION[i][0] + ((PLAYER_INFO_BAR_WIDTH - (POKER_WIDTH*2 - 30))/2),PLAYER_INFO_BAR_POSITION[i][1] - POKER_HEIGHT),
                  (PLAYER_INFO_BAR_POSITION[i][0] + PLAYER_INFO_BAR_WIDTH - ((PLAYER_INFO_BAR_WIDTH - (POKER_WIDTH*2 - 30))/2)-(POKER_WIDTH),PLAYER_INFO_BAR_POSITION[i][1] - POKER_HEIGHT)]
