...
loginPageInputs = [Input(kw.USERNAME  ,20,USERNAME_BOX_RECT  ,TABLE_COLOR            ,COMBO_REMINDER_BG_COLOR,COMBO_REMINDER_BG_COLOR,(244, 244, 244)),
                   Input(kw.PASSWORD  ,20,PASSWORD_BOX_RECT  ,COMBO_REMINDER_BG_COLOR,COMBO_REMINDER_BG_COLOR,TABLE_COLOR            ,(244, 244, 244)),
                   Input(kw.C_PASSWORD,20,C_PASSWORD_BOX_RECT,COMBO_REMINDER_BG_COLOR,COMBO_REMINDER_BG_COLOR,TABLE_COLOR            ,(244, 244, 244))]